...
only predefined immediate pointer types are @racket[void_t*] and
@racket[void_t*/gcable] (and they are treated the same as a parent
...
(ffi2-ref (ffi2-ref p void_t*) double_t)
]

...
(let ()
  ...
  (ffi2-set! p intbool_t 'ok)
  (check-equal? (ffi2-ref p intbool_t) #t))
...
(let ()
  ...
  (check-equal? (ffi2-cast (ffi2-ref p void_t*/gcable) #:to bytes_t) #"apple")
  (define ptr (ffi2-cast (ffi2-ref p void_t*/gcable) #:offset 6))

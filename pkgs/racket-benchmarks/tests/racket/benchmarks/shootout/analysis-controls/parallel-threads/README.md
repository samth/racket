...
| `knucleotide.rkt` | Private full histograms; long-fragment workers share initialized read-only DNA bytes. |
| `regexredux.rkt` | Two pattern-count workers share read-only input; parent performs the five ordered substitutions. |

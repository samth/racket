...
(define translation (make-vector 256))
...
(define first-header (read-bytes-line I 'any))
(unless (eof-object? first-header)
  (write-bytes first-header O)
  (newline O)

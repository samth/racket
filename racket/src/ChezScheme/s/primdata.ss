...
(define-symbol-flags* ([libraries] [flags primitive proc]) ; srfi 19
  ...
  (time-difference! (sig [(time time) -> (time)]) [flags alloc])
  (time-nanosecond [sig [(time) -> (uint)]] [flags discard true])
  (time-second [sig [(time) -> (exact-integer)]] [flags discard true])
  (time-type [sig [(time) -> (symbol)]] [flags discard true])
...
(define-symbol-flags* ([libraries] [flags primitive proc])
  ...
  (cost-center-allocation-count [sig [(cost-center) -> (number)]] [flags discard true])
  (cost-center-instruction-count [sig [(cost-center) -> (number)]] [flags discard true])
  (cost-center-time [sig [(cost-center) -> (time)]] [flags discard true])
  ...
  (gensym->unique-string [sig [(gensym) -> (string)]] [flags true]) ; has interning side effect
  ...
  (port-name [sig [(port) -> (ptr)]] [flags discard])
  ...
  (sstats-bytes [sig [(sstats) -> (exact-integer)]] [flags discard])
  (sstats-cpu [sig [(sstats) -> (time)]] [flags discard])
  (sstats-difference [sig [(sstats sstats) -> (sstats)]] [flags mifoldable discard true])
  (sstats-gc-bytes [sig [(sstats) -> (exact-integer)]] [flags discard])
  (sstats-gc-count [sig [(sstats) -> (exact-integer)]] [flags discard])
  (sstats-gc-cpu [sig [(sstats) -> (time)]] [flags discard])
  (sstats-gc-real [sig [(sstats) -> (time)]] [flags discard])
  (sstats-print [sig [(sstats) (sstats textual-output-port) -> (void)]] [flags true])
  (sstats-real [sig [(sstats) -> (time)]] [flags discard])
  ...
  (unbox [sig [(box) -> (ptr)]] [flags discard cp02 safeongoodargs])

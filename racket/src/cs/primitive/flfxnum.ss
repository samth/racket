...
(define-primitive-table flfxnum-table
  ...
  [flvector-ref (known-procedure 4)] ; not folding: flvectors are mutable
  [flvector-set! (known-procedure 8)] ; not folding: mutation
  ...
  [fxvector-ref (known-procedure 4)] ; not folding: fxvectors are mutable
  [fxvector-set! (known-procedure 8)] ; not folding: mutation

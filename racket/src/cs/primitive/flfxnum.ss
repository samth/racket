...
(define-primitive-table flfxnum-table
  ...
  [flreal-part (known-procedure/has-unsafe/folding 2 'unsafe-flreal-part)]
  ...
  [flvector-ref (known-procedure/no-prompt 4)]
  [flvector-set! (known-procedure/no-prompt 8)]
  ...
  [fxvector-ref (known-procedure/no-prompt 4)]
  [fxvector-set! (known-procedure/no-prompt 8)]
  [fxvector? (known-procedure/pure/folding 2)]
  [fxxor (known-procedure/folding/limited -1 'fixnum)]
  [make-flrectangular (known-procedure/has-unsafe/folding 4 'unsafe-make-flrectangular)]

...
(define-primitive-table unsafe-table
  ...
  [unsafe-flrandom (known-procedure 2)] ; not folding: random is non-deterministic
  ...
  [unsafe-place-local-ref (known-procedure 2)] ; not then-pure: place locals are mutable
  [unsafe-place-local-set! (known-procedure 4)] ; not then-pure: mutation

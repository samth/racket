...
(define-primitive-table unsafe-table
  ...
  [unsafe-flrandom (known-procedure/no-prompt 2)]
  ...
  [unsafe-flhypot (known-procedure/then-pure/folding-unsafe 4 'flhypot)]
  ...
  [unsafe-place-local-ref (known-procedure/no-prompt 2)]
  [unsafe-place-local-set! (known-procedure/no-prompt 4)]
